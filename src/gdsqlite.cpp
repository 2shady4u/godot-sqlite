...
void SQLite::_bind_methods() {
	...
	// Signals.
	ADD_SIGNAL(MethodInfo("row_inserted", PropertyInfo(Variant::STRING, "table"), PropertyInfo(Variant::INT, "pkey")));
	ADD_SIGNAL(MethodInfo("row_updated", PropertyInfo(Variant::STRING, "table"), PropertyInfo(Variant::INT, "pkey")));
	ADD_SIGNAL(MethodInfo("row_deleted", PropertyInfo(Variant::STRING, "table"), PropertyInfo(Variant::INT, "pkey")));
}
